    ...
    <div class="bg-gray-900">
        <div class="px-6 pt-12 lg:px-8 lg:pt-20">
            <div class="text-center">
                <h2 class="text-xl font-semibold leading-6 text-gray-300">{{data.title}}</h2>
                <p class="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl lg:text-5xl">{{data.paragraph}}</p>
                <p class="mx-auto mt-3 max-w-4xl text-xl text-gray-300 sm:mt-5 sm:text-2xl">{{data.paragraphTwo}}</p>
            </div>
        </div>
                                    ...
                                    <div class="flex flex-1 flex-col justify-between border-t-2 border-gray-100 bg-gray-50 p-6 sm:p-10 lg:p-6 xl:p-10">
                                        <ul role="list" class="space-y-4">
                                            <li v-for="economy in data.plans.economic.featuresEconomic" :key="economy" class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base font-medium text-gray-500">{{ economy }}</p>
                                            </li>
                                        </ul>
                                        <div class="mt-8">
                                ...
                                <div class="rounded-b-lg border-t-2 border-gray-100 bg-gray-50 px-6 pt-10 pb-8 sm:px-10 sm:py-10">
                                    <ul role="list" class="space-y-4">
                                        <li v-for="medium in data.plans.medium.featuresMedium" :key="medium" class="flex items-start">
                                            ...
                                            <p class="ml-3 text-base font-medium text-gray-500">{{ medium }}</p>
                                        </li>
                                    </ul>
                                    <div class="mt-10">
                                        <div class="rounded-lg shadow-md">
                                    ...
                                    <div class="flex flex-1 flex-col justify-between border-t-2 border-gray-100 bg-gray-50 p-6 sm:p-10 lg:p-6 xl:p-10">
                                        <ul role="list" class="space-y-4">
                                            <li v-for="expensive in data.plans.expensive.featuresExpensive" :key="expensive" class="flex items-start">
                                                ...
                                                <p class="ml-3 text-base font-medium text-gray-500">{{ expensive }}</p>
                                            </li>
                                        </ul>
                                        <div class="mt-8">
                                            <div class="rounded-lg shadow-md">
