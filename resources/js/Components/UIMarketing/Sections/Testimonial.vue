            ...
            <div class="py-12 px-6 md:flex md:flex-col md:border-r md:border-indigo-900 md:py-16 md:pl-0 md:pr-10 lg:pr-16">
                ...
                <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
                    <div class="relative text-lg font-medium text-white md:flex-grow">
                        ...
                        <p class="relative">{{data.people.first.paragraph}}</p>
                    </div>
                    <footer class="mt-8">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <div class="text-base font-medium text-white">{{ data.people.first.name }}</div>
                                <div class="text-base font-medium text-indigo-200">{{ data.people.first.jobPosition }}</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
            ...
            <div class="border-t-2 border-indigo-900 py-12 px-6 md:border-t-0 md:border-l md:py-16 md:pr-0 md:pl-10 lg:pl-16">
                ...
                <blockquote class="mt-6 md:flex md:flex-grow md:flex-col">
                    <div class="relative text-lg font-medium text-white md:flex-grow">
                        ...
                        <p class="relative">{{data.people.second.paragraph}}</p>
                    </div>
                    <footer class="mt-8">
                        <div class="flex items-start">
                            <div class="inline-flex flex-shrink-0 rounded-full border-2 border-white">
                            ...
                            <div class="ml-4">
                                <div class="text-base font-medium text-white">{{ data.people.second.name }}</div>
                                <div class="text-base font-medium text-indigo-200">{{ data.people.second.jobPosition }}</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
