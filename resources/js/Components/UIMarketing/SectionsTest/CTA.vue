                ...
                <div class="px-6 pt-10 pb-12 sm:px-16 sm:pt-16 lg:py-16 lg:pr-0 xl:py-20 xl:px-20">
                    <div class="lg:self-center">
                        <h2 class="text-3xl font-bold tracking-tight text-white sm:text-4xl">
                            ...
                            <span class="block">{{data.titleH2}}</span>
                        </h2>
                        <p class="mt-4 text-lg leading-6 text-indigo-200">{{data.paragraph}}</p>
                        <a href="#" class="mt-8 inline-flex items-center rounded-md border border-transparent bg-white px-5 py-3 text-base font-medium text-black shadow hover:bg-black hover:text-white">{{data.button}}</a>
                    </div>
                </div>
