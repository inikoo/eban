...
<template layout="UIMarketingLayout">
    ...
    De conformidad con lo dispuesto en el Reglamento General (UE) Sobre Protección de Datos, mediante la aceptación de la presente Política de Privacidad prestas tu consentimiento informado, expreso, libre e inequívoco para que los datos personales que proporciones a través de la página web https://romualdfons.com/ (en adelante SITIO WEB) sean incluidos en un fichero de “USUARIOS WEB Y SUSCRIPTORES” así como “CLIENTES Y/O PROVEEDORES”:

    Mi denominación social es: MI TALADRO PERFORARÁ EL CIELO S.L.
    Mi CIF es B-66958349
    Mi domicilio social se encuentra en Calle Felip II, 289, INT. 10, 08016 Barcelona.
    Email: info@bigseoagency.com
    Mi actividad social es: blogging, Marketing digital y SEO.

    Todo ello debidamente inscrito ante la agencia Española de Protección de Datos y respecto del que MI TALADRO PERFORARÁ EL CIELO S.L garantiza que se han aplicado las medidas de seguridad tanto organizativas como técnicas requeridas por el RGPD.
    ...
    La venta de formación y servicios sobre SEO y posicionamiento WEB.
    La venta de Plantillas WordPress
    Gestionar la lista de suscriptores y usuarios adscritos al curso.
    ...
    En el supuesto de ser mayor de trece años, podrás registrarte en https://romualdfons.com/ sin necesidad del consentimiento previo de tus padres o tutores.
    ...
    MI TALADRO PERFORARÁ EL CIELO S.L hasta la fecha cumple con las directrices de la Ley Orgánica 15/1999 de 13 de diciembre de Protección de Datos de Carácter Personal, el Real Decreto 1720/2007 de 21 de diciembre por el que se aprueba el Reglamento de desarrollo de dicha Ley Orgánica y demás normativa vigente y de aplicación en cada momento, velando por garantizar un correcto uso y tratamiento de los datos personales del usuario.

    A partir de mayo de 2018, nos regiremos por la normativa que entrará en aplicación, siendo el Reglamento General sobre Protección de Datos (RGPD) de la Unión Europea.

    Asimismo, MI TALADRO PERFORARÁ EL CIELO S.L informa que da cumplimiento a la Ley 34/2002 de 11 de julio, de Servicios de la Sociedad de la Información y el Comercio Electrónico y le solicitará su consentimiento al USUARIO para el tratamiento de su correo electrónico con fines comerciales en cada momento.

    En cumplimiento de lo establecido en la normativa, le informamos que los datos suministrados, así como aquellos datos derivados de su navegación, podrán ser almacenados en los ficheros de MI TALADRO PERFORARÁ EL CIELO S.L y tratados para la finalidad de atender su solicitud y el mantenimiento de la relación que se establezca en los formularios que suscriba.

    Adicionalmente, el USUARIO consiente el tratamiento de sus datos con la finalidad de informarles, por cualquier medio, incluido el correo electrónico, de productos y servicios de MI TALADRO PERFORARÁ EL CIELO S.L
    ...
    MI TALADRO PERFORARÁ EL CIELO S.L le informa que tiene implantadas las medidas de seguridad de índole técnica y organizativas necesarias para garantizar la seguridad de sus datos de carácter personal y evitar su alteración, pérdida y tratamiento y/o acceso no autorizado, habida cuenta del estado de la tecnología, la naturaleza de los datos almacenados y los riesgos a que están expuestos, ya provengan de la acción humana o del medio físico o natural. Todo ello de conformidad con lo previsto en el RGPD.

    Asimismo, MI TALADRO PERFORARÁ EL CIELO S.L ha establecido medidas adicionales en orden a reforzar la confidencialidad e integridad de la información en su organización. Manteniendo continuamente la supervisión, control y evaluación de los procesos para asegurar el respeto a la privacidad de los datos.

    5. EJERCICIO DE DERECHOS

    Aquellas personas físicas que hayan facilitado sus datos a través de https://romualdfons.com/, podrán dirigirse al titular de la misma con el fin de poder ejercitar gratuitamente sus derechos de acceso a sus datos, rectificación o supresión, limitación y oposición respecto de los datos incorporados en sus ficheros.
    ...
    El interesado podrá ejercitar sus derechos mediante comunicación por escrito dirigida a MI TALADRO PERFORARÁ EL CIELO S.L con la referencia “Protección de datos”, especificando sus datos, acreditando su identidad y los motivos de su solicitud en la siguiente dirección:

    MI TALADRO PERFORARÁ EL CIELO S.L
    Calle Felip II, 289, INT. 10,
    08016 Barcelona.

    También podrá ejercitar los derechos, a través del correo electrónico: info@bigseoagency.com

    6. LINKS O ENLACES EXTERNOS

    Como un servicio a nuestros visitantes, nuestro sitio web puede incluir hipervínculos a otros sitios que no son operados o controlados por el Sitio Web. Por ello https://romualdfons.com/ no garantiza, ni se hace responsable de la licitud, fiabilidad, utilidad, veracidad y actualidad de los contenidos de tales sitios web o de sus prácticas de privacidad. Por favor, antes de proporcionar su información personal a estos sitios web ajenos a https://romualdfons.com/, tenga en cuenta que sus prácticas de privacidad pueden diferir de las nuestras.

    El único objeto de los enlaces es proporcionar al Usuario la posibilidad de acceder a dichos enlaces y conocer nuestro trabajo, aunque vcgs.net no ofrece ni comercializa por sí ni por medio de terceros la información, contenidos y servicios disponibles en los sitios enlazados, ni aprueba, supervisa o controla en modo alguno los contenidos y servicios y cualquier material de cualquier naturaleza existente en los mismos. https://romualdfons.com/ no se responsabiliza en ningún caso de los resultados que puedan derivarse al Usuario por acceso a dichos enlaces.

    7. MODIFICACIÓN DE LA POLÍTICA DE PRIVACIDAD

    MI TALADRO PERFORARÁ EL CIELO S.L se reserva el derecho a modificar su Política de Privacidad, de acuerdo a su propio criterio, motivado por un cambio legislativo, jurisprudencial o doctrinal de la Agencia Española de Protección de Datos.

    Cualquier modificación de la Política de Privacidad será publicada al menos diez días antes de su efectiva aplicación. El uso de MI TALADRO PERFORARÁ EL CIELO S.L después de dichos cambios, implicará la aceptación de los mismos.

    8. RESPONSABLE DEL FICHERO, Y ENCARGADOS DEL TRATAMIENTO.

    El responsable del fichero de datos es MI TALADRO PERFORARÁ EL CIELO S.L.

    Como encargados de tratamiento ajenos al citado responsable:

    MI TALADRO PERFORARÁ EL CIELO S.L ha contratado los servicios de Hosting a mercantil OVH HISPANO, S.L.U. (en adelante, OVH HISPANO), con CIF B-83834747 e inscrita en el Registro Mercantil de Madrid, al Tomo 19514, Libro 0, Folio 77, Sección 8, Hoja M-342678. El domicilio social está en Madrid, C/ Princesa nº 22, 2º Dcha., 28008 Madrid, más información en https://www.ovh.es/soporte/documentos_legales/Aviso_legal.pdf

    Los servicios de suscripción por correo electrónico y envío de newsletters a la compañía Active Campaign LLC (Identificada por la marca comercial “Active Campaign”) pudiéndose consultar su política de privacidad en http://www.activecampaign.com/privacy-policy/

    9. SERVICIOS OFRECIDOS POR TERCEROS EN ESTA WEB.

    Para prestar servicios estrictamente necesarios para el desarrollo de mi actividad, https://romualdfons.com/ utiliza los siguientes prestadores bajo sus correspondientes condiciones de privacidad.

    Hosting: OVH
    Plataforma web: WordPress.Org
    Tema web: Orbital Theme
    Servicios de Mensajería y envío de boletines: Active Campaign
    Plataforma de pago: Woocomerce
    Medios de pago: Stripe y Paypal
    Plataforma de Webinar: WebinarJam
    Privacidad de fuentes de rastreo utilizadas en este sitio: Google (Analytics)

    En https://romualdfons.com/ también se estudian las preferencias de sus usuarios, sus características demográficas, sus patrones de tráfico, y otra información en conjunto para comprender mejor quiénes constituyen nuestra audiencia y qué es lo que necesita. El rastreo de las preferencias de nuestros usuarios también nos ayuda a mostrarle los avisos publicitarios más relevantes.

    El usuario y, en general, cualquier persona física o jurídica, podrá establecer un hiperenlace o dispositivo técnico de enlace (por ejemplo, links o botones) desde su sitio web a https://romualdfons.com/ (el “Hiperenlace“). El establecimiento del Hiperenlace no implica en ningún caso la existencia de relaciones entre https://romualdfons.com/ y el propietario del sitio o de la página web en la que se establezca el Hiperenlace, ni la aceptación o aprobación por parte de https://romualdfons.com/ de sus contenidos o servicios. En todo caso, https://romualdfons.com/ se reserva el derecho de prohibir o inutilizar en cualquier momento cualquier Hiperenlace al Sitio Web.
    ...
    Para ello, deberás enviar un correo electrónico a la dirección info@bigseoagency.com. Si has recibido publicidad por correo electrónico, también podrás oponerte desde dicho correo electrónico, pinchando en el enlace incluido en el mismo siguiendo las instrucciones que te sean facilitadas. Otra forma más sencilla sería acceder a tu cuenta de usuario y seleccionar las opciones correspondientes.
    ...
    En relación con la gestión de tus datos asociados a los perfiles sociales de MI TALADRO PERFORARÁ EL CIELO S.L , el ejercicio del derecho de acceso, dependerá de la funcionalidad de la red social y las posibilidades de acceso a la información de los perfiles de los usuarios. Con relación a los derechos de acceso y rectificación, le recomendamos que solo podrá satisfacerse en relación a aquella información que se encuentre bajo el control de MI TALADRO PERFORARÁ EL CIELO S.L .

    Además podrá dejar de interactuar, seguir o recibir información de los perfiles sociales de MI TALADRO PERFORARÁ EL CIELO S.L , eliminar los contenidos que dejen de interesarte o restringir con quien comparte sus conexiones, mediante los mecanismos estipulados en las diferentes redes sociales.

    El usuario podrá acceder a las políticas de privacidad de cada Red Social, así como configurar su perfil para garantizar su privacidad. MI TALADRO PERFORARÁ EL CIELO S.L anima a los usuarios a familiarizarse con las condiciones de uso de las distintas redes sociales antes de comenzar a usarlas.
    ...
    1) Formularios de suscripción a contenidos: dentro de la web existen varios formularios para activar la suscripción gestionada por Getresponse con la finalidad de enviar campañas de marketing por correo electrónico, gestión de suscripciones y envío de boletines o noticias.
    ...
    5) Venta de inforpoductos: A través de la página web, se pueden adquirir infoproductos, en este caso, se requieren datos del comprador (Nombre, apellido, dirección, e-mail, número de identificación fiscal (NIF/VAT/IVA), País) mediante la plataforma Woocommerce.

    6) Los usuarios podrán darse de baja en cualquier momento de los servicios prestados por https://romualdfons.com/ desde la misma Newsletter a través de un formulario de cancelación.

    7) Sistemas de rastreo utilizadas en este sitio: Google (Analytics y Tag Manager), en https://romualdfons.com/ también se estudian las preferencias de sus usuarios, sus características demográficas, sus patrones de tráfico, y otra información en conjunto para comprender mejor quiénes constituyen su audiencia y qué es lo que esta necesita. Puedes conocer la política de privacidad general de los servicios de Google aquí. Adicionalmente, puedes conocer cómo utiliza Google la información de sitios web o aplicaciones que utilizan sus servicios aquí.
    ...
    Asimismo, me gustaría informarte que para la captación de suscriptores y clientes utilizo Facebook Ads por lo que al generar un anuncio, se puede segmentar el público por el lugar, datos demográficos, intereses, etc por lo que los datos obtenidos por esta plataforma, estarían sujetos a esta política de privacidad desde el momento en que el usuario acepta la política de cookies y privacidad.

    Finalmente, me gustaría informarte que para brindar una mejor experiencia a mi lista de suscriptores y clientes utilizó sistemas de rastreo de Active Campaign (ver su política de privacidad) por lo que los datos obtenidos por esta plataforma, estarían sujetos a esta política de privacidad desde el momento en que el usuario deja sus datos para unirse al boletín de mi comunidad.

    No voy a compartir, vender, alquilar tu información personal con otras partes. Puedo compartir cierta información con los proveedores de servicios de terceros autorizados necesarios para prestar algunos servicios.
    ...
    El Usuario declara haber sido informado de las condiciones sobre protección de datos de carácter personal, aceptando y consintiendo el tratamiento de los mismos por parte de MI TALADRO PERFORARÁ EL CIELO S.L en la forma y para las finalidades indicadas en el aviso legal.
