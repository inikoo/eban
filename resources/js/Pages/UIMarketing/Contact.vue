...
<template layout="UIMarketingLayout">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3">
        <!-- Contact information -->
        <div class="relative overflow-hidden bg-gradient-to-b from-green-500 to-yellow-300  sm:ml-0 md:ml-0 lg:ml-8 px-6 sm:px-10 xl:p-12 rounded-3xl py-32 ">
            ...
            <p class="mt-6 max-w-3xl text-base text-black">Nullam risus blandit ac aliquam justo ipsum. Quam mauris volutpat massa dictumst amet. Sapien tortor lacus arcu.</p>
        ...
        <div class="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
            ...
            <form action="#" method="POST" class="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                ...
                <div class="sm:col-span-2 sm:flex sm:justify-end">
                    <button type="submit" class="mt-2 inline-flex w-full items-center justify-center rounded-md  border-transparent bg-gradient-to-r from-green-500 to-yellow-300 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:w-auto">Submit</button>
                </div>
            </form>
        </div>
    </div>
