...
import CavinContactPageImage from "@/../../public/Images/CavinContactPageImage.png";
...
<template layout="UIMarketingLayout">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3">
        <!-- Contact information -->
        <div
            class="relative overflow-hidden bg-gradient-to-b from-green-500 to-yellow-300  sm:ml-0 md:ml-0 lg:ml-8 px-6 sm:px-10 xl:p-12 rounded-3xl py-32 ">
    ...
    <div class="grid grid-cols-4 gap-4 h-auto text-center bg-gray-50 items-center mt-6 hidden md:grid lg:grid">
        <div class="grid object-center ">
            <img class="  object-cover"
                 :src="CavinContactPageImage"
                 alt=""/>
        </div>
        <div class="grid"></div>
        <div class="grid"></div>
        ...
        <div class="grid">
            <img class="  object-cover"
                 :src="MountainWaterContactPageImage"
                 alt=""/>
        </div>
        <div class="grid"></div>
        <div class="grid">
            <img class="  object-cover"
                 :src="MountainFieldContactPageImage"
                 alt=""/></div>
        <div class="grid"></div>
        <div class="grid"></div>
    </div>
    <div class="grid justify-center md:hidden lg:hidden xl:hidden 2xl:hidden">
        <div class="">
            <div class="mx-auto max-w-7xl py-12 px-6 lg:py-16 lg:px-8">
                <h2 class="inline text-3xl font-bold tracking-tight text-gray-900 sm:block sm:text-4xl">Want product news and updates?</h2>
                <p class="inline text-3xl font-bold tracking-tight text-indigo-600 sm:block sm:text-4xl">Sign up for our newsletter.</p>
